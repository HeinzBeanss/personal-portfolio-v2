const Skills = () => {
  return (
    <div className="relative z-20 flex gap-4 w-full justify-center">
      {/* HTML */}
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-xs font-light">HTML</p>
        </div>
        <svg
        ...
        <svg
          className="max-w-32 absolute animate-rotate-backward-slower"
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-xs font-light">CSS</p>
        </div>
        <svg
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        ...
        <svg
          className="max-w-32 absolute animate-javascript-rotate"
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-xs font-light">React</p>
        </div>
        <svg
          className="max-w-32 absolute animate-rotate-forward-slower"
          viewBox="0 0 100 100"
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-xs font-light">Node</p>
        </div>
        <svg
          className="max-w-32  absolute animate-rotate-forward-slower"
          viewBox="0 0 100 100"
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-xs font-light">PHP</p>
        </div>
        <svg
          className="max-w-32  absolute animate-rotate-forward-slower"
          viewBox="0 0 100 100"
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-xs font-light">Git</p>
        </div>
        <svg
          className="max-w-32 absolute animate-rotate-forward-slower"
          viewBox="0 0 100 100"
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-xs font-light">Adobe</p>
        </div>
