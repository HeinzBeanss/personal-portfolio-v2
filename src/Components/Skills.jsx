    ...
    <div className="relative z-20 flex gap-4 w-full justify-center max-w-screen-lg mx-auto">
      <div className="flex flex-col">
        <div className="flex gap-2 sm:gap-8 justify-center">
          {/* HTML */}
          <div className="mt-8 w-16 h-16 sm:w-36 sm:h-36 relative flex justify-center items-center">
            <div className="flex flex-col items-center gap-2">
              <svg viewBox="0 0 128 128" className="w-4 sm:w-10 rounded-lg">
                <path
                  fill="#E4faff"
              ...
              <p className="text-white tracking-wider text-xs font-light">
                HTML
              </p>
            </div>
            <svg
              className="max-w-16 sm:max-w-36 absolute animate-rotate-forward-faster"
              viewBox="0 0 100 100"
            ...
            <svg
              className="max-w-12 sm:max-w-32 absolute animate-rotate-backward-slower"
              viewBox="0 0 100 100"
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle
          ...
          <div className="mt-8 w-16 h-16 sm:w-36 sm:h-36 relative flex justify-center items-center">
            ...
            <svg
              className="max-w-12 sm:max-w-32 absolute animate-rotate-forward-slower"
              viewBox="0 0 100 100"
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle
            ...
            <svg
              className="max-w-16 sm:max-w-36 absolute animate-rotate-backward-faster"
              viewBox="0 0 100 100"
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle
          ...
          <div className="mt-8 w-16 h-16 sm:w-36 sm:h-36 relative flex justify-center items-center">
            ...
            <svg
              className="max-w-12 sm:max-w-32 absolute animate-javascript-rotate"
              viewBox="0 0 100 100"
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle
            ...
            <div className="w-36 p-2.5 absolute test-div-4  animate-rotate-forward-slower ">
        ...
        <div className="flex gap-2 sm:gap-8 justify-center">
          ...
          <div className="mt-8 w-16 h-16 sm:w-36 sm:h-36 relative flex justify-center items-center">
            ...
            <svg
              className="max-w-16 sm:max-w-36  absolute animate-rotate-forward-slower"
              viewBox="0 0 100 100"
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle
            ...
            <svg
              className="max-w-12 sm:max-w-32 rotate-12 absolute animate-node-circle-two"
              viewBox="0 0 100 100"
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle
          ...
          <div className="mt-8 w-16 h-16 sm:w-36 sm:h-36 relative flex justify-center items-center">
            <div className="flex flex-col items-center gap-2">
              <svg viewBox="0 0 128 128" className="w-4 sm:w-10">
                <path
                  fill="url(#a)"
          ...
          <div className="mt-8 w-16 h-16 sm:w-36 sm:h-36 relative flex justify-center items-center">
            <div className="flex flex-col items-center gap-2">
              <svg viewBox="0 0.388 121.5 89.61" className="w-4 sm:w-10">
                <path
            ...
            <svg
              className="max-w-12 sm:max-w-32 absolute animate-scale-circle"
              viewBox="0 0 100 100"
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle
