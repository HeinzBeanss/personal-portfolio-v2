const Skills = () => {
  return (
    <div className="flex gap-4 w-full justify-center">
      {/* HTML */}
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-sm font-light">HTML</p>
        </div>
        <svg
          className="max-w-36 absolute -rotate-90 test-svg-a"
          viewBox="0 0 100 100"
        ...
        <svg
          className="max-w-32 absolute -rotate-90 test-svg-a"
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-sm font-light">CSS</p>
        </div>
        <svg
          className="max-w-32 p-0.5 absolute -rotate-90 test-svg"
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle className="circle-21" cx="50" cy="50" r="45" />
        </svg>

        <svg
          className="max-w-36 absolute -rotate-90 test-svg-2"
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle className="circle-22" cx="50" cy="50" r="45" />
        </svg>
      </div>
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-sm font-light">JS</p>
        </div>
        <svg
          className="max-w-32 p-0.5 absolute -rotate-90 test-svg"
          viewBox="0 0 100 100"
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-sm font-light">REACT</p>
        </div>
        <svg
          className="max-w-32 p-0.5 absolute -rotate-90 test-svg"
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle className="circle-testtwo" cx="50" cy="50" r="45" />
        </svg>
        <div className="w-36 absolute -rotate-90 test-div-2">
          <div className="w-2 h-2 rounded-full bg-lightest test-anim"></div>
        </div>
      </div>
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-sm font-light">NODE</p>
        </div>
        <svg
          className="max-w-32 p-0.5 absolute -rotate-90 test-svg"
          viewBox="0 0 100 100"
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-sm font-light">PHP</p>
        </div>
        <svg
          className="max-w-32 p-0.5 absolute -rotate-90 test-svg"
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle className="circle-11" cx="50" cy="50" r="45" />
        </svg>
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle className="circle-12" cx="50" cy="50" r="45" />
        </svg>
      </div>
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-sm font-light">
            Laravel
          </p>
        </div>
        <svg
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-white tracking-wider text-sm font-light">GIT</p>
        </div>
        <svg
          className="max-w-32 p-0.5 absolute -rotate-90 test-svg"
          viewBox="0 0 100 100"
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle className="circle-test" cx="50" cy="50" r="45" />
        </svg>
      </div>
      ...
      <div className="mt-8 w-36 h-36 relative flex justify-center items-center">
        <div className="flex flex-col items-center gap-2">
          <svg viewBox="0 0.388 121.5 89.61" className="w-12">
            <path
          ...
          <p className="text-white tracking-wider text-sm font-light">ADOBE</p>
        </div>
        <div className="w-0 h-36 absolute -rotate-90 test-div-3">
          <div className="w-3 h-3 rounded-full bg-white/90 test-anim"></div>
        </div>

        <div className="w-0 h-40 absolute -rotate-90 test-div-2">
          <div className="w-2 h-2 rounded-full bg-white/90 test-anim"></div>
        </div>
      </div>
    </div>
  );
