...
const AboutMe = () => {
  return (
    <div className="relative mt-72 mb-12 mx-auto max-w-screen-lg text-white/90 tracking-wider text-justify">
      ...
      <div className="flex justify-center items-center mb-5 ">
        ...
        <svg
          className="max-w-3 -rotate-90 test-svg-small"
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle className="circle-small" cx="50" cy="50" r="45" />
        </svg>
        <div className="w-96 border-lightest border-b opacity-60"></div>
        <svg
          className="max-w-3 -rotate-90 test-svg-small-back"
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle className="circle-small" cx="50" cy="50" r="45" />
      ...
      <img
        src={star}
        alt="star"
        className="absolute bottom-96 left-48 max-w-10"
      />
      {/* <img
        src={star}
        alt="star"
        className="absolute max-w-10 top-72 left-48 opacity-60"
      /> */}
      <img
        src={star}
        alt="star"
        className="absolute max-w-10 bottom-80 right-48 opacity-80"
      />
      <img
        src={star}
        alt="star"
        className="absolute max-w-10 top-40 -left-60 opacity-70"
      />
      <img
        src={star}
        alt="star"
        className="absolute max-w-10 top-0 -right-40 opacity-80"
      />
      <img
        src={star}
        alt="star"
        className="absolute max-w-10 -top-24 -left-96 opacity-50"
      />
      {/* <img
        src={star}
        alt="star"
      ...
      <img
        src={star}
        alt="star"
        className="absolute max-w-10 top-96 -right-1/3 opacity-50"
      />
      {/* <img
        src={star}
        alt="star"
