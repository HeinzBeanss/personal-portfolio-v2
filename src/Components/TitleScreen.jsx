  ...
  return (
    <div className="relative w-full h-screen flex flex-col justify-center items-center pb-40 3xl:pb-72 gap-8 parallax-wrap">
      ...
      <img
        src={star}
        alt="star"
        className="star-parallax hidden sm:block absolute bottom-96 left-20 max-w-10"
        value="-2"
      />
      <img
        src={star}
        alt="star"
        className="star-parallax hidden sm:block  absolute max-w-10 top-52 left-48 opacity-60"
        value="4"
      />
      <img
        src={star}
        alt="star"
        className="star-parallax hidden sm:block  absolute max-w-10 bottom-32 right-48 opacity-80"
        value="6"
      />
      <img
        src={star}
      ...
      <img
        src={star}
        alt="star"
        className="star-parallax hidden sm:block  absolute max-w-10 bottom-20 left-96 opacity-80"
        value="1"
      />
      <img
        src={star}
