  ...
  return (
    <div className="relative w-full h-screen flex flex-col justify-center items-center pb-40 3xl:pb-72 gap-8 parallax-wrap">
      ...
      <img
        src={star}
        alt="star"
        className="star-parallax sm:block absolute bottom-52 left-4 sm:bottom-96 sm:left-20 max-w-10 opacity-40 sm:opacity-50"
        value="-2"
      />
      <img
        src={star}
        alt="star"
        className="star-parallax sm:block absolute max-w-10 top-20 left-12 sm:top-52 sm:left-48 opacity-30"
        value="4"
      />
      <img
        src={star}
      ...
      <img
        src={star}
        alt="star"
        className="star-parallax hidden sm:block absolute max-w-10 top-96 inset-x-1/3 opacity-20"
        value="-3"
      />
      <img
        src={star}
        alt="star"
        className="star-parallax hidden sm:block absolute max-w-10 top-60 right-32 opacity-10"
        value="-5"
      />
      <img
        src={star}
        alt="star"
        className="star-parallax hidden sm:block absolute max-w-10 top-1/2 right-96 opacity-40"
        value="-2"
      />
      <img
        src={star}
        alt="star"
        className="star-parallax sm:block absolute max-w-10 bottom-20 left-96 opacity-20"
        value="1"
      />
      <img
        src={star}
        alt="star"
        className="star-parallax hidden sm:block absolute max-w-10 top-32 right-1/3 opacity-20"
        value="3"
      />
      <img
        src={star}
        alt="star"
        className="star-parallax hidden sm:block absolute max-w-10 top-2 right-2/3 opacity-40"
        value="-2"
      />
    </div>
  );
